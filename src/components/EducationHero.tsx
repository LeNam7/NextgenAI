    ...
    <div className="relative pt-36 pb-20 overflow-hidden bg-slate-900 text-white text-center">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 space-y-4">
        <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-slate-800/80 border border-slate-700/80 text-xs font-bold text-indigo-400 backdrop-blur-sm">
          ...
          <span>{t({ vi: "Hệ Sinh Thái Đào Tạo AI Thực Chiến K-12", en: "Hands-on K-12 AI Educational Ecosystem" })}</span>
        </div>

        <h2 className="text-4xl sm:text-5xl font-extrabold tracking-tight">
          {t({ vi: "Giáo Dục AI", en: "AI Education" })}
        </h2>
        <p className="text-slate-400 text-base sm:text-lg max-w-2xl mx-auto font-medium">
          {t({
            vi: "Tiên phong tích hợp công nghệ AI vào giảng dạy và học tập, kiến tạo thế hệ học sinh Việt Nam làm chủ tương lai số.",
            en: "Pioneering AI integration in teaching and learning, empowering Vietnamese students to master the digital future."
          })}
        </p>
      </div>
    </div>
